...
button_container_t button_container_create(Vector2 position)
{
	button_container_t container = {0};
...
void button_container_append(button_container_t* container, text_t text, Color normal_color, Color selected_color)
{
	Vector2 position = {
...
void button_container_draw(button_container_t container)
{
...
void button_container_update_sizes(button_container_t *container)
{
...
void button_container_update_position(button_container_t *container, const Vector2 position)
{
	container->position = position;
